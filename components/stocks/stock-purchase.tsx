...
const initialData = {
  words: {
    'word-1': {id: 'word-1', 'content': 'Ik'},
    'word-2': {id: 'word-2', 'content': 'hen'},
    'word-3': {id: 'word-3', 'content': 'een'},
    'word-4': {id: 'word-4', 'content': 'broer'},
  },
  sentences: {
    'answer': {
      id: 'answer',
      title: 'translated sentence',
      wordIds: []
    },
    'options': {
      id: 'options',
...
export function Purchase({
                           props: {language, sentence, translated, status = 'requires_action'}
                         }: {
  props: Purchase
}) {
  ...
  const {confirmPurchase} = useActions() // it's coming from @/app/actions.tsx and I have to change it then to confirm my answer
  // < button
  ...
  function onWordOrderChange(e: React.ChangeEvent<HTMLInputElement>) {
